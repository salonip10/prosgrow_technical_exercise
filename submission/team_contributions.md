...
- Wrote `integration_note.md` covering environment setup, authentication, API endpoint, required parameters, how to run the tool, a working example, errors encountered
